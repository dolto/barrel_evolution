...
use crate::{
    enemy::{aim::aim_sprite_setup, structs::enemy_mesh_setup_system},
    gun::systems::DESPAWN_BULLETS_Z,
};
...
impl Plugin for EnemyPlugin {
    fn build(&self, app: &mut App) {
        info!("EnemyPlugin Setup");
        app.add_systems(Startup, (enemy_mesh_setup_system, aim_sprite_setup))
